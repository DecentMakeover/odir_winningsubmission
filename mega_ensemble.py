...
json_file = 'saved_models/exp_15/exp_15_model.json'
weights_path="saved_models/exp_15/exp_15_wieghts.h5"
...
###
json_file2 = 'saved_models/exp_14/exp_14_model.json'
weights_path2="saved_models/exp_14/exp_14_wieghts.h5"
...
print("Loaded model from disk")
###
json_file4 = 'saved_models/exp_12/exp_12_model.json'
weights_path4="saved_models/exp_12/0.29.hdf5"
...
print("Loaded model from disk")
###
json_file5 = 'saved_models/exp_9/exp_9_model.json'
weights_path5="saved_models/exp_9/exp_9_wieghts.h5"
json_file5 = open(json_file5, 'r')
loaded_model_json = json_file5.read()
model5 = model_from_json(loaded_model_json)
# load weights into new model
model5.load_weights(weights_path5)
print("Loaded model from disk")
###
...
for i in tqdm(range(10)):
    ...
    preds4 = model4.predict_generator(generator=test_generator,steps = ceil(df_test_left.shape[0]))    
    preds5 = model5.predict_generator(generator=test_generator,steps = ceil(df_test_left.shape[0]))    
    preds_tta_1.append(preds)
    preds_tta_2.append(preds2)
    preds_tta_3.append(preds3)
    preds_tta_4.append(preds4)
    preds_tta_5.append(preds5)

# -----------------------------------------------------  
pred_left_1 = np.mean(preds_tta_1, axis=0)    
pred_left_2 = np.mean(preds_tta_2, axis=0)    
pred_left_3 = np.mean(preds_tta_3, axis=0)    
pred_left_4 = np.mean(preds_tta_4, axis=0)    
pred_left_5 = np.mean(preds_tta_5, axis=0)    
...
pred_right_4 = np.mean(preds_tta_4, axis=0)    
pred_right_5 = np.mean(preds_tta_5, axis=0)    
...
final_predict_4 = 0.5*pred_left_4+0.5*pred_right_4
final_predict_5 = 0.5*pred_left_5+0.5*pred_right_5


np.savetxt("exp_15_wieghts.csv", final_predict_1, delimiter=",")  
np.savetxt("exp_14_wieghts.csv", final_predict_2, delimiter=",")                                                                                                                                             
np.savetxt("exp_11_wieghts.csv", final_predict_3, delimiter=",")                                                                                                                                             
np.savetxt("0.29.csv", final_predict_4, delimiter=",")                                                                                                                                             
np.savetxt("exp_9_wieghts.csv", final_predict_5, delimiter=",")                                                                                                                                             


final_predict = 0.5*final_predict_1+0.3*final_predict_2+0.1*final_predict_3*0.2*final_predict_4+0.4*final_predict_5
